...
class CP300:
    def __init__(self):
        self.HEADERS = ['Time', 'Outlet Temp', 'Boiler Temp', 'Warm Plate Temp', 'Max Temp', 'Calibrated Offset Temp',
                        'Pump PWM', 'Boiler On/Off', 'PTC On/Off', 'Flow rate', 'Current Block Volume',
                        'Current Total Volume', 'Clean Count', 'Recipe Size', 'Recipe Brew', 'Recipe Block',
                        'Recipe Total Volume', 'Recipe Time']
        self.SUB_HEADERS = ['sec.', 'degC', 'degC', 'degC', 'degC', 'degC']
        self.SUMMARY_HEADERS = ['Max. Outlet Temp', 'Max. Boiler Temp', 'Max. Warm Plate Temp', 'Max. Flowrate']
        self.SUMMARY_SUB_HEADERS = ['degC', 'degC', 'degC', 'ml/sec.']
    ...
    def parse(self, Myfiles):
        ...
        for myfile in Myfiles:
            ...
            for index, i in enumerate(self.SUB_HEADERS):
            ...
            try:
                ...
                chart1, chart2, chart3, chart4 = self.excelGraph(workbook, finalRow)
                worksheet.insert_chart('B2', chart1)
                worksheet.insert_chart('B22', chart2)
                worksheet.insert_chart('O2', chart3)
                worksheet.insert_chart('O22', chart4)

                self.closeworkbook(workbook)
